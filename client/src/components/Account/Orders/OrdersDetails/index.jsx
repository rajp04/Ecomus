    ...
    <div className="border rounded-md p-5">
      <div className="flex items-center space-x-3 border-dashed border-b pb-5">
        ...
        <div className="flex flex-col space-y-1">
          ...
          <h1 className="sm:text-2xl text-xl font-medium">Order #17493</h1>
        </div>
      </div>
      <div className="grid sm:grid-cols-2 grid-cols-1 md:gap-10 gap-5 pt-7">
        <div className="col-span-1 space-y-1">
          <h1 className="opacity-60 text-lg">Item</h1>
          <h1 className="font-semibold text-xl">Fashion</h1>
        </div>
        <div className="col-span-1 space-y-1">
          <h1 className="opacity-60 text-lg">Courier</h1>
          <h1 className="font-semibold text-xl">Ribbed modal T-shirt</h1>
        </div>
        <div className="col-span-1 space-y-1">
          <h1 className="opacity-60 text-lg">Start Time</h1>
          <h1 className="font-semibold text-xl">04 September 2024, 13:30:23</h1>
        </div>
        <div className="col-span-1 space-y-1">
          <h1 className="opacity-60 text-lg">Address</h1>
          <h1 className="font-semibold text-xl">1234 Fashion Street, Suite 567, New York</h1>
        </div>
      </div>
      <div className="flex items-center space-x-7 pt-10 border-b">
        ...
        <h1 className={`font-medium text-xl cursor-pointer transition-colors duration-500 border-b-2 pb-3 ${select === 'details' ? 'text-[red] border-[red] border-b-2' : 'hover:border-[red] border-white hover:text-[red]'}`} onClick={() => handleSelect('details')}>Item Details</h1>
        ...
        <h1 className={`font-medium text-xl cursor-pointer transition-colors duration-500 border-b-2 pb-3 ${select === 'receiver' ? 'text-[red] border-[red] border-b-2' : 'hover:border-[red] border-white hover:text-[red]'}`} onClick={() => handleSelect('receiver')}>Receiver</h1>
      </div>
      <div className="pt-7">
